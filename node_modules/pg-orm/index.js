...
PgORM.prototype.getForm = function( callBack ){
    ...
    if( this.attributesRule )
    {
        ...
        // Когда все задачи закончатся запустится callBack
        q.start(function(err) {
            console.log( "Закончил создавать input" );
    ...
    if( type == "relations-BELONGS_TO" || type == "relations-HAS_MANY"  ) {
        ...
        this.getAttribute( field, function ( selectedItem ){
            ...
            if( type == "relations-BELONGS_TO" ){
                console.log( "Выделенный: "+selectedItem.getAttribute("id") );
                var selectedIid = selectedItem.getAttribute("id");
            }
            else{
                console.log( "Выделенный: "+selectedItem );
                var selectedIid = selectedItem;
            }
                ...
                listValueModel.fetchAll({order:"name"}, function ( items ){
                    if( type == "relations-BELONGS_TO" ){
                        ...
                        for( var i=0;i<items.length;i++ ){
                            ...
                            input += "<option value=\""+id+"\" "+( id == selectedIid ? "selected" : "" )+" >"+items[i].getAttribute("name")+"</option>";
                        }

                        input += "</select>";
                    }
                        else {
                        input += "<div class='panel panel-info'><div class='panel-body relationHasMenyBlock'>";
